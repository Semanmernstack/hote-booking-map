  ...
  return (
    <div className=" flex flex-col w-full overflow-x-hidden  ">
       ...
       <div onClick={() => router.push("/")}  className="text-2xl cursor-pointer">
        <h1 className="sm:text-sm md:text-2xl">PemsBooking</h1>
       </div>
       <div className="flex items-center sm:w-7 shadow-xl p-2 rounded-full">
       ...
       {search && 
        <div className='flex flex-col sm:max-w-[200px] md:max-w-[300px] ml-4 mx-auto '>
          <DateRangePicker
          ...
          <div className=" text-red-700 flex items-center  gap-24 ">
            <h1 className='w-5 text-red bg-red-50 ml-4'>Number of Guests</h1>
