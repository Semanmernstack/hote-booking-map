...
function Header() {
  ...
  return (
    <div className=" grid grid-cols-3 overflow-x-hidden  ">
        <div className=' flex flex-col items-center justify-evenly bg-blue-500 h-14 md:h-20'>
       ...
       {search && 
        <div className='flex flex-col sm:max-w-[200px] md:max-w-[300px] ml-4 lg:items-center  justify-center'>
          <DateRangePicker
