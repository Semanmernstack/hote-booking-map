...
export async function getServerSideProps(context) {
  const resultSearch = await fetch(`https://travel-advisor.p.rapidapi.com/hotels/list-in-boundary?keys=${7a1706fbddmsh98a75c4bc93c077p1c919ejsn6d007d292f09}&base=${travel-advisor.p.rapidapi.com}`)
  .then((res) => res.json());
  return {
    props: {
