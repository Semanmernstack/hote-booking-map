...
function Search({ resultSearch }) {
    ...
    const rapiToken = '7a1706fbddmsh98a75c4bc93c077p1c919ejsn6d007d292f09'
    const base = travel-advisor.p.rapidapi.com
  return (
...
export async function getServerSideProps(context) {
  const resultSearch = await fetch(`https://travel-advisor.p.rapidapi.com/hotels/list-in-boundary.json()?keys=${rapiToken}`)
  .then((res) => res.json());
  return {
    props: {
