...
function Search({ resultSearch }) {
    ...
    const token = '7a1706fbddmsh98a75c4bc93c077p1c919ejsn6d007d292f09'
...
export async function getServerSideProps(context) {
  const resultSearch = await fetch(`https://airbnb19.p.rapidapi.com/api/v1/getLanguages'?keys=${token}`)
  .then((res) => res.json());
  return {
    props: {
